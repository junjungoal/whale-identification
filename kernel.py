...
TRAIN_DF = '/media/hdd1/jun/kaggle/whale_identification/train.csv'
SUB_Df = '/media/hdd1/jun/kaggle/whale_identification/sample_submission.csv'
TRAIN = '/media/hdd1/jun/kaggle/whale_identification/train/'
TEST = '/media/hdd1/jun/kaggle/whale_identification/test/'
P2H = '/media/hdd1/jun/kaggle/whale_identification/metadata/p2h.pickle'
P2SIZE = '/media/hdd1/jun/kaggle/whale_identification/metadata/p2size.pickle'
BB_DF = "/media/hdd1/jun/kaggle/whale_identification/metadata/bounding_boxes.csv"
...
if isfile('/media/hdd1/jun/kaggle/whale_identification/mpiotte-standard.model'):
    tmp = keras.models.load_model('/media/hdd1/jun/kaggle/whale_identification/standard_250.model')
...
#model.save('/media/hdd1/jun/kaggle/whale_identification/standard_50_iter.model')
# epoch -> 150
#for i in range(18):
#    make_steps(5, 1.0)
    #model.save('/media/hdd1/jun/kaggle/whale_identification/standard_{}.model'.format((i+1)*5 + 60))
# epoch -> 200
#set_lr(model, 16e-5)
#for _ in range(10):
    #make_steps(5, 0.5)
    #model.save('/media/hdd1/jun/kaggle/whale_identification/standard_{}.model'.format((i+1)*5 + 150))
# epoch -> 240
#set_lr(model, 4e-5)
#for i in range(8):
#    make_steps(5, 0.25)
#    model.save('/media/hdd1/jun/kaggle/whale_identification/standard_{}.model'.format((i+1)*5 + 240))
# epoch -> 250
#set_lr(model, 1e-5)
#for _ in range(2):
#    make_steps(5, 0.25)
#    model.save('/media/hdd1/jun/kaggle/whale_identification/standard_{}.model'.format((i+1)*5 + 280))
# epoch -> 300
...
#for i in range(10):
#    make_steps(5, 1.0)
#    model.save('/media/hdd1/jun/kaggle/whale_identification/standard_{}.model'.format((i+1)*5 + 290))
# epoch -> 350
#set_lr(model, 16e-5)
...
#model.save('/media/hdd1/jun/kaggle/whale_identification/standard.model')
